...
5.  **เข้าถึง API Documentation (Swagger)**:
    -   เปิดเบราว์เซอร์และไปที่ `http://localhost:3000`
    -   คุณจะเห็น Swagger UI ที่แสดง API Documentation แบบ Interactive
    -   สามารถทดสอบ API endpoints ได้โดยตรงผ่าน Swagger UI
...
*   **Swagger UI**: ระบบมี API Documentation แบบ Interactive ที่ path `/` (root)
*   **ข้อดีของ Swagger**:
    *   **Interactive Testing**: สามารถทดสอบ API ได้โดยตรงผ่านเบราว์เซอร์ ไม่ต้องใช้ Postman
    *   **Auto-generated Documentation**: Documentation ถูกสร้างอัตโนมัติจาก JSDoc comments ในโค้ด
    *   **Schema Validation**: แสดง Request/Response Schema ที่ชัดเจน
    *   **Easy to Understand**: UI ที่เข้าใจง่าย แสดงข้อมูล Endpoints, Parameters, และ Response ทั้งหมด
*   **การใช้งาน**:
    1.  เปิดเบราว์เซอร์ไปที่ `http://localhost:3000`
    2.  เลือก Endpoint ที่ต้องการทดสอบ
    3.  กดปุ่ม "Try it out"
    4.  ใส่ข้อมูล Request Body หรือ Parameters
    5.  กดปุ่ม "Execute" เพื่อทดสอบ API
